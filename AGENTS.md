# AI Team Skills — OpenAI Codex CLI Agent Instructions (v2.4.0)
...
**ATTENTION CODEX CLI**: You are integrated with the AI Team Skills framework (v2.4.0). You MUST follow these instructions immediately:
