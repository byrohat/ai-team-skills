...
> Auto-loaded by Google Antigravity as workspace rules (`.agents/rules/`). You do **not** need the
...
and `team-lead.md`. See also `AGENTS.md` and `GEMINI.md` at the project root.
