---
trigger: always_on
description: AI Team Skills — autonomous 18-agent engineering team. Always on; activates itself without being asked.
---

# AI Team Skills — AUTONOMOUS ACTIVATION (v2.4.0)

> Auto-loaded by Windsurf (Cascade) as a workspace rule (`.windsurf/rules/`, `trigger: always_on`).
> You do **not** need the user to ask you to "activate" — turn yourself on.
...
3. Adopt the relevant agent persona by reading its `.windsurf/skills/<agent>.md` (mirror of
   `.claude/skills/`) before doing domain work.
...
Full roster, slash commands, and standards live in `.windsurf/skills/` — start with `_core-protocols.md`
and `team-lead.md`.
